...
//    DWORD dwOptions_rec = DMA_FROM_DEVICE | DMA_ALLOW_CACHE | DMA_ALLOW_64BIT_ADDRESS;
    ...
    TrigPulser pulser;
    PCIE::mod_address_t module;
    module.trigger_id=16;
    module.shaper_id=6;
    module.xmit_id=10;
    module.fem_id=11;
    pulser.SetModulePtr(&module);
    pulser.SetDevicePtr(&hDev);

    pulser.SetP1Delay(p1_delay);
    pulser.SetP1Width(p1_width);
    pulser.SetP2Delay(p2_delay);
    pulser.SetP2Width(p2_width);

    pulser.SetTrigDelay(pulse_trig_delay);
