...
public:
  ...
  */
  const pmt_waveform*   get_current_ch_data(){return &_ch_data;};
...
#define INCLUDE_EXTRA_HEADER
  ...
  PMT::word_t _beam_ref_nwords; ///< Number of ADC samples in beam ref channel
  PMT::word_t _beam_ref_sample; ///< Sample number in beam ref channel
  PMT::word_t _beam_ref_frame;  ///< Frame ID from beam ref channel 
