...
public:
  ...
  void set_ref_channel(PMT::ch_number_t ch){_ref_ch=ch;};

  void set_frame_size(PMT::word_t frame_size){_frame_size=frame_size;};

  void set_time_cut(PMT::word_t time_cut){_time_cut = time_cut;};
