...
/**
   ...
   See Analysis/mac/led_pulse_analyzer.py for an example usage.
 */
...
public:
  ...
  void set_pulse_type(DATA_STRUCT::DATA_TYPE type){_selector.set_pulse_type(type);};

  void set_ref_channel(PMT::ch_number_t ch){_selector.set_ref_channel(ch);};

  void set_frame_size(PMT::word_t frame_size){_selector.set_frame_size(frame_size);};

  void set_time_cut(PMT::word_t time_cut){_selector.set_time_cut(time_cut);};
