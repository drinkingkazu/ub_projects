...
public:
  ...
  */
  ...
  void set_range_frame_id(PMT::word_t v1, PMT::word_t v2) {_cut_frame_id.first=v1; _cut_frame_id.second=v2; };

  /// Setter for the range of timeslice to select pulses of interest.
  void set_range_timeslice(PMT::word_t v1, PMT::word_t v2) {_cut_timeslice.first=v1; _cut_timeslice.second=v2; };
  ...
  const std::pair<PMT::word_t,PMT::word_t> range_frame_id() const {return _cut_frame_id;};

  /// Getter for the range of timeslice to select pulses of interest.
  const std::pair<PMT::word_t,PMT::word_t> range_timeslice() const {return _cut_timeslice;};
